...
$tl="MaxClean Laundry | Blog Right";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="boxed_wrapper">
    ...
    <section class="page-title centred" style="background-image: url(images/about/page-title.jpg);">
        <div class="container">
            <div class="content-box">
                <div class="title"><h2>blog right sidebar</h2></div>
            </div>
        </div>
    </section>
    <!--End Page Title-->
    ...
    <!-- blog-classic -->
    <section class="blog-classic blog-right-sidbar sidbar-page-container">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-12 col-xs-12 content-side">
                    <div class="blog-classic-content default-blog-content">
                        <div class="single-blog-content">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="title"><h3><a href="blog-details.html">101 Lanundry tips, tricks and hacks</a></h3></div>
                                <div class="text">
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia aliquam quaerat voluptatem.</p>
                                </div>
                            </div>
                        </div>
                        <div class="single-blog-content">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="title"><h3><a href="blog-details.html">4 Ways to Simplify Laundry</a></h3></div>
                                <div class="text">
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia aliquam quaerat voluptatem.</p>
                                </div>
                            </div>
                        ...
                        <div class="single-blog-content">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="title"><h3><a href="blog-details.html">A guide to home stain removal</a></h3></div>
                                <div class="text">
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia aliquam quaerat voluptatem.</p>
                                </div>
                            </div>
                        </div>
                        <ul class="page-pagination clearfix float-right">
