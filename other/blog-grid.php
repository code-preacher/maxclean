...
<body class="boxed_wrapper">
    ...
    <section class="page-title centred" style="background-image: url(images/about/page-title.jpg);">
        <div class="container">
            <div class="content-box">
                <div class="title"><h2>blog grid</h2></div>
            </div>
        </div>
    </section>
    <!--End Page Title-->
    ...
    <section class="blog-grid">
        <div class="container">
            <div class="sec-title centred"><h2>Our Blog</h2></div>
            <div class="title-text centred">In this blog you will find laundry solutions for stressed out moms. Rotary clotheslines offer you one<br /> of the simplest and cheapest ways to dry clothes and laundry outdoors.</div>
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 news-column">
                    <div class="single-news-content single-item-hoverly first-column">
                        <figure class="img-box">
                            ...
                            <div class="overlay">
                                <a href="blog-details.html" class="btn-one btn-bg">Read More</a>
                            </div>
                        </figure>
                        <ul class="meta in-block">
                            <li>Post by : Will Smith</li>
                            <li>18 April,2020</li>
                            <li><i class="fa fa-comments"></i>&nbsp;14</li>
                        </ul>
                        <div class="lower-content">
                            <div class="title"><h4><a href="blog-details.html">101 Lanundry tips, tricks and hacks</a></h4></div>
                            <div class="text">
                                <p>When it comes to laundry, we know a thing or two.  Here’s a list of 101 of our favorite tips, tricks and hacks to help make getting the ...</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 news-column">
                    <div class="single-news-content single-item-hoverly">
                        <figure class="img-box">
                        ...
                        <div class="lower-content">
                            <div class="title"><h4><a href="blog-details.html">Dry cleaning saves money in the long run</a></h4></div>
                            <div class="text">
                                <p>People are often reluctant to dry clean their clothing because it is more expensive .....</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 news-column">
                    <div class="single-news-content single-item-hoverly">
                        ...
                        <div class="lower-content">
                            <div class="title"><h4><a href="blog-details.html">How to get rid of smoke odor on clothes</a></h4></div>
                            <div class="text">
                                <p>We all know that smell. The one that lingers after a night out bar hopping, dinner ...</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 news-column">
                    <div class="single-news-content single-item-hoverly first-column">
                        ...
                        <div class="lower-content">
                            <div class="title"><h4><a href="blog-details.html">A guide to home stain removal</a></h4></div>
                            <div class="text">
                                <p>When it comes to stains, there are some instances where it is better to let your dry cleaner do the work.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 news-column">
                    <div class="single-news-content single-item-hoverly">
                        ...
                        <div class="lower-content">
                            <div class="title"><h4><a href="blog-details.html">Putting your wedding gown on display</a></h4></div>
                            <div class="text">
                                <p>There is a new trend among those who preserve their wedding gowns.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 news-column">
                    <div class="single-news-content single-item-hoverly">
                        ...
                        <div class="lower-content">
                            <div class="title"><h4><a href="blog-details.html">4 Ways to Simplify Laundry</a></h4></div>
                            <div class="text">
                                <p>We all know that smell. The one that lingers after a night out bar hopping, dinner ...</p>
                            </div>
                        </div>
            ...
            <div class="news-btn centred"><h4><a href="#">Load More</a></h4></div>
        </div>
    </section>
    <!-- blog-grid end -->
