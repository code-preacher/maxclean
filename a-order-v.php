    ...
    <section class="page-title centred" style="background-image: url(images/about/page-title.jpg);">
        <div class="container">
            <div class="content-box">
                <div class="title"><h2>All Order / Payment</h2></div>
            </div>
        </div>
    </section>
    <!--End Page Title-->
...
$qd=mysqli_query($con,"select * from booking  order by id desc");
$c=0;
while ($f=mysqli_fetch_array($qd)) {
    ...
    ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center;"><a href="<?=$site?>a-payt?id=<?=$f['payment_ref']?>"><i class="fa fa-refresh"></i></a> </td>
                                                <td style="text-align:center;"><a href="<?=$site?>a-delt?id=<?=$f['payment_ref']?>"><i class="fa fa-refresh"></i></a> </td>
                                                <td><?php echo $f['date_created'];?></td>
                                                <td><a href="<?=$site?>a-order-f?id=<?=$f['payment_ref']?>"><i class="fa fa-eye"></i></a> | <a href="<?=$site?>a-del?id=<?=$f['payment_ref']?>" onClick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash"></i></a></td>
