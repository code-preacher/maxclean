    ...
    <section class="page-title centred" style="background-image: url(images/about/page-title.jpg);">
        <div class="container">
            <div class="content-box">
                <div class="title"><h2>Confirmed Payment</h2></div>
            </div>
        </div>
    </section>
    <!--End Page Title-->
...
$qd=mysqli_query($con,"select * from booking where payment_status='1' order by id desc");
$c=0;
