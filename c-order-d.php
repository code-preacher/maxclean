    ...
    <section class="page-title centred" style="background-image: url(images/about/page-title.jpg);">
        <div class="container">
            <div class="content-box">
                <div class="title"><h2>Delivered Order</h2></div>
            </div>
        </div>
    </section>
    <!--End Page Title-->
...
$qd=mysqli_query($con,"select * from booking where delivery_status='1'");
$c=0;
while ($f=mysqli_fetch_array($qd)) {
    ...
    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $f['delivery_status'];?></td>
                                                <td><?php echo $f['date_created'];?></td>
                                                <td><a href="#" onClick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash"></i></a></td>
