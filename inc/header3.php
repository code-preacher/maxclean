                ...
                <div class="menu-area">
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            ...
                            <li><a href="<?=$site?>c-dashboard">Dashboard</a></li>
                                        <li><a href="<?=$site?>c-order">Order Now</a></li>
                                        <li><a href="<?=$site?>c-order-v">All Order</a></li>
                                        <li><a href="<?=$site?>c-profile">Profile</a></li>
                                        <li><a href="<?=$site?>c-logout">Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
