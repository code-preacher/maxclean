             ...
             <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-12  contact-column">
                    <div class="contact-form-area">
                        ...
                        <form method="post" action="<?=$site?>c-pass" id="contact-form" class="default-form">
                            <div class="row">
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <input type="text"  value="<?php echo $pv['name']; ?>" required disabled>
                                </div>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <input type="text"  value="<?php echo $pv['phone']; ?>" required disabled>
                                </div>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <textarea required disabled><?php echo $pv['address']; ?></textarea>
                                </div>
