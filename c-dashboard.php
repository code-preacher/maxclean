...
?>
    ...
    <section class="working-section sp-one centred">
        <div class="container">
             <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 working-column">
                <a href="<?=$site?>c-order-v">
                    <div class="single-working-content">
                        <div class="icon-box">
                            <div class="icon"><i class="fa fa-briefcase"></i></div>
                        </div>
                        <h3>My Booked Order</h3>
                        <div class="count-text">
                        <?php 
                            $cn2=mysqli_query($con,"select * from booking WHERE uid='$uid'");
